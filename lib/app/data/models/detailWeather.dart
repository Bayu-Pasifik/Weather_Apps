...
//
//     final detailWeather = detailWeatherFromJson(jsonString);

import 'dart:convert';

DetailWeather detailWeatherFromJson(String str) => DetailWeather.fromJson(json.decode(str));

String detailWeatherToJson(DetailWeather data) => json.encode(data.toJson());
